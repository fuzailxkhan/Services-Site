...
const Login = () => {
  ...
  return (
    (
        <div className=" p-3 pt-10 max-w-[400px] h-[400px] m-auto mx-8 sm:mx-auto mt-10 mb-96 bg-gray-100 rounded-lg shadow-lg">
        <form onSubmit={handleSubmit((data)=>{onLogin(data)})} >
          ...
          <div className=" flex flex-col m-3">
            ...
            <div className=" flex flex-col relative">
              ...
              <input className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500  ps-12 p-2.5" {...register("email", {required:{value:true,message:"Enter your email."},pattern: {value: /\S+@\S+\.\S+/,message: "Enter a valid email."}})}   id="email" placeholder="Please enter you email" />
            </div>
          ...
          <div className="flex flex-col m-3">
            ...
            <div className="flex flex-col relative">
              ...
              <input {...register("password",{required:true})} className=" bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500  ps-12 p-2.5" placeholder='Enter your password' id="password" />
            </div>
