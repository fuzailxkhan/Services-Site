    ...
    <div>
        <nav className="min-h-10 grid grid-cols-2 p-2 m-2 rounded-lg sm:grid-cols-3 shadow-xl border mb-2">
            ...
            <div className='grid grid-cols-2 col-span-1 justify-self-end sm:justify-self-center self-center'>
                <p className='self-center justify-self-center font-semibold text-blue-700 hover:text-black'><NavLink className={({isActive})=>`${isActive&&"border-b-4 border-blue-500 pb-3.5 px-2"}`} to="/Login">Login</NavLink></p>
